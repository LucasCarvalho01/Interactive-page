...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _modules_bookmark_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/bookmark.js */ \"./js/modules/bookmark.js\");\n/* harmony import */ var _modules_getData_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/getData.js */ \"./js/modules/getData.js\");\n/* harmony import */ var _modules_makePledge_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/makePledge.js */ \"./js/modules/makePledge.js\");\n/* harmony import */ var _modules_menu_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/menu.js */ \"./js/modules/menu.js\");\n\n\n\n\n\nconst menu = new _modules_menu_js__WEBPACK_IMPORTED_MODULE_3__[\"default\"]('menuHam');\nmenu.init();\n\n(0,_modules_bookmark_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"])('bookmark');\n\n// Class that get values about project when opening page\nconst showData = new _modules_getData_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"]('totalAmount', 'totalPeople', 'daysLeft', 'progress');\nshowData.init();\n\n// Class that updates current values on page\nconst makePledge = new _modules_makePledge_js__WEBPACK_IMPORTED_MODULE_2__[\"default\"]('modal', 'back', 'reward1', 'reward2', 'reward3');\nmakePledge.init();\n\nconsole.log('oi');\n\n//# sourceURL=webpack://crowdfunding-product-page-main/./js/script.js?");
...
eval("module.exports = __webpack_require__(/*! ./lib/axios */ \"./node_modules/axios/lib/axios.js\");\n\n//# sourceURL=webpack://crowdfunding-product-page-main/./node_modules/axios/index.js?");
...
"use strict";
eval("\n\nvar AxiosError = __webpack_require__(/*! ../core/AxiosError */ \"./node_modules/axios/lib/core/AxiosError.js\");\nvar utils = __webpack_require__(/*! ../utils */ \"./node_modules/axios/lib/utils.js\");\n\n/**\n * A `CanceledError` is an object that is thrown when an operation is canceled.\n *\n * @class\n * @param {string=} message The message.\n */\nfunction CanceledError(message) {\n  // eslint-disable-next-line no-eq-null,eqeqeq\n  AxiosError.call(this, message == null ? 'canceled' : message, AxiosError.ERR_CANCELED);\n  this.name = 'CanceledError';\n}\n\nutils.inherits(CanceledError, AxiosError, {\n  __CANCEL__: true\n});\n\nmodule.exports = CanceledError;\n\n\n//# sourceURL=webpack://crowdfunding-product-page-main/./node_modules/axios/lib/cancel/CanceledError.js?");
...
"use strict";
eval("\n\nmodule.exports = function isCancel(value) {\n  return !!(value && value.__CANCEL__);\n};\n\n\n//# sourceURL=webpack://crowdfunding-product-page-main/./node_modules/axios/lib/cancel/isCancel.js?");
...
"use strict";
eval("\n\nvar utils = __webpack_require__(/*! ./../utils */ \"./node_modules/axios/lib/utils.js\");\nvar defaults = __webpack_require__(/*! ../defaults */ \"./node_modules/axios/lib/defaults/index.js\");\n\n/**\n * Transform the data for a request or a response\n *\n * @param {Object|String} data The data to be transformed\n * @param {Array} headers The headers for the request or response\n * @param {Array|Function} fns A single function or Array of functions\n * @returns {*} The resulting transformed data\n */\nmodule.exports = function transformData(data, headers, fns) {\n  var context = this || defaults;\n  /*eslint no-param-reassign:0*/\n  utils.forEach(fns, function transform(fn) {\n    data = fn.call(context, data, headers);\n  });\n\n  return data;\n};\n\n\n//# sourceURL=webpack://crowdfunding-product-page-main/./node_modules/axios/lib/core/transformData.js?");
...
"use strict";
eval("\n\nmodule.exports = {\n  silentJSONParsing: true,\n  forcedJSONParsing: true,\n  clarifyTimeoutError: false\n};\n\n\n//# sourceURL=webpack://crowdfunding-product-page-main/./node_modules/axios/lib/defaults/transitional.js?");
...
eval("module.exports = {\n  \"version\": \"0.27.2\"\n};\n\n//# sourceURL=webpack://crowdfunding-product-page-main/./node_modules/axios/lib/env/data.js?");
...
"use strict";
eval("\n\nmodule.exports = function bind(fn, thisArg) {\n  return function wrap() {\n    var args = new Array(arguments.length);\n    for (var i = 0; i < args.length; i++) {\n      args[i] = arguments[i];\n    }\n    return fn.apply(thisArg, args);\n  };\n};\n\n\n//# sourceURL=webpack://crowdfunding-product-page-main/./node_modules/axios/lib/helpers/bind.js?");
...
"use strict";
eval("\n\n/**\n * Creates a new URL by combining the specified URLs\n *\n * @param {string} baseURL The base URL\n * @param {string} relativeURL The relative URL\n * @returns {string} The combined URL\n */\nmodule.exports = function combineURLs(baseURL, relativeURL) {\n  return relativeURL\n    ? baseURL.replace(/\\/+$/, '') + '/' + relativeURL.replace(/^\\/+/, '')\n    : baseURL;\n};\n\n\n//# sourceURL=webpack://crowdfunding-product-page-main/./node_modules/axios/lib/helpers/combineURLs.js?");
...
"use strict";
eval("\n\n/**\n * Determines whether the specified URL is absolute\n *\n * @param {string} url The URL to test\n * @returns {boolean} True if the specified URL is absolute, otherwise false\n */\nmodule.exports = function isAbsoluteURL(url) {\n  // A URL is considered absolute if it begins with \"<scheme>://\" or \"//\" (protocol-relative URL).\n  // RFC 3986 defines scheme name as a sequence of characters beginning with a letter and followed\n  // by any combination of letters, digits, plus, period, or hyphen.\n  return /^([a-z][a-z\\d+\\-.]*:)?\\/\\//i.test(url);\n};\n\n\n//# sourceURL=webpack://crowdfunding-product-page-main/./node_modules/axios/lib/helpers/isAbsoluteURL.js?");
...
"use strict";
eval("\n\nvar utils = __webpack_require__(/*! ./../utils */ \"./node_modules/axios/lib/utils.js\");\n\n/**\n * Determines whether the payload is an error thrown by Axios\n *\n * @param {*} payload The value to test\n * @returns {boolean} True if the payload is an error thrown by Axios, otherwise false\n */\nmodule.exports = function isAxiosError(payload) {\n  return utils.isObject(payload) && (payload.isAxiosError === true);\n};\n\n\n//# sourceURL=webpack://crowdfunding-product-page-main/./node_modules/axios/lib/helpers/isAxiosError.js?");
...
"use strict";
eval("\n\nvar utils = __webpack_require__(/*! ../utils */ \"./node_modules/axios/lib/utils.js\");\n\nmodule.exports = function normalizeHeaderName(headers, normalizedName) {\n  utils.forEach(headers, function processHeader(value, name) {\n    if (name !== normalizedName && name.toUpperCase() === normalizedName.toUpperCase()) {\n      headers[normalizedName] = value;\n      delete headers[name];\n    }\n  });\n};\n\n\n//# sourceURL=webpack://crowdfunding-product-page-main/./node_modules/axios/lib/helpers/normalizeHeaderName.js?");
...
eval("// eslint-disable-next-line strict\nmodule.exports = null;\n\n\n//# sourceURL=webpack://crowdfunding-product-page-main/./node_modules/axios/lib/helpers/null.js?");
...
"use strict";
eval("\n\nmodule.exports = function parseProtocol(url) {\n  var match = /^([-+\\w]{1,25})(:?\\/\\/|:)/.exec(url);\n  return match && match[1] || '';\n};\n\n\n//# sourceURL=webpack://crowdfunding-product-page-main/./node_modules/axios/lib/helpers/parseProtocol.js?");
...
"use strict";
eval("\n\n/**\n * Syntactic sugar for invoking a function and expanding an array for arguments.\n *\n * Common use case would be to use `Function.prototype.apply`.\n *\n *  ```js\n *  function f(x, y, z) {}\n *  var args = [1, 2, 3];\n *  f.apply(null, args);\n *  ```\n *\n * With `spread` this example can be re-written.\n *\n *  ```js\n *  spread(function(x, y, z) {})([1, 2, 3]);\n *  ```\n *\n * @param {Function} callback\n * @returns {Function}\n */\nmodule.exports = function spread(callback) {\n  return function wrap(arr) {\n    return callback.apply(null, arr);\n  };\n};\n\n\n//# sourceURL=webpack://crowdfunding-product-page-main/./node_modules/axios/lib/helpers/spread.js?");
